...
import {AreaChart,Area, XAxis, YAxis, CartesianGrid, Tooltip ,Bar,
  BarChart,Legend,Line,LineChart , PieChart,Pie,
...
function DashboardIndex() {
  ...
  <Pie data={data02} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={60} outerRadius={80} fill="#82ca9d" label />
        ...
        <Card>
         <CardContent>
         <RadarChart outerRadius={90} width={550} height={250} data={data3}>
  <PolarGrid />
